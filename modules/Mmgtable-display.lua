...
function p.main(frame)
	...
	local skills = { 'agility', 'attack', 'construction', 'cooking', 'crafting', 'defence', 'farming', 'firemaking',
	...
	for _, skill in ipairs(skills) do
    	skillLimits[skill] = paramTest.default_to(tonumber(args[skill]), math.huge)
	end
